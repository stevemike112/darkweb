...
if(localStorage.getItem('banklogs') && ((JSON.parse(localStorage.getItem('banklogs')).length) > 0)){
    ...
    setBtn.innerHTML = `Telegram <img src="img/partners/telegram.png">`;
    setBtn.removeAttribute('data-bs-toggle');
    setBtn.setAttribute('href', 'https://t.me/carl37');
    setBtn.setAttribute('target', '_blank');
}
